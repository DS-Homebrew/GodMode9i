...
STRING(FAILED_TO_DUMP_ROM_DEST_SPACE, "Failed to dump the ROM: destination ran out of space.")
STRING(UNABLE_TO_DUMP_ROM, "Unable to dump the ROM.")
STRING(FAILED_TO_DUMP_SAVE, "Failed to dump the save.")
STRING(FAILED_TO_DUMP_SAVE_DEST_SPACE, "Failed to dump the save: destination ran out of space.")
...
STRING(A_SELECT_LANGUAGE, "(\\A select language)")
...
STRING(DIAG_TITLE, "Hardware info")
STRING(DIAG_CONSOLE_TYPE, "Console type")
STRING(DIAG_UNIT, "Unit")
STRING(DIAG_WIFI_BOARD, "WiFi board")
STRING(DIAG_RAM, "RAM")
STRING(DIAG_REGION, "Region")
STRING(DIAG_SERIAL, "Serial")
STRING(DIAG_CONSOLE_ID, "Console ID")
STRING(DIAG_WIFI_MAC, "WiFi MAC")
STRING(DIAG_SCROLL_HINT, "Up/Down: scroll")
STRING(DIAG_CONTINUE, "A: Continue")
STRING(DIAG_RETAIL, "Retail")
STRING(DIAG_DEBUG, "Debug")
STRING(DIAG_ENABLED, "Enabled")
STRING(DIAG_DISABLED, "Disabled")
